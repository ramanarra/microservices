export const queries = {
    ...
    getPossibleListAppointmentDatesFor7Days: 'select appointment_date from appointment  where "doctorId" = ? and appointment_date >= current_date group by appointment_date limit 7',
