...
export class CalendarController {
    ...
    @ApiOkResponse({ description: 'request body example:    {"appointmentId": "251", "prescriptionList" : [{"medicineList": [{"typeOfMedicine":"syrup", "countOfDays":"30", "doseOfMedicine":"10 ml"},{"typeOfMedicine":"syrup", "countOfDays":"30", "doseOfMedicine":"10 ml"}]},{"medicineList": [{"typeOfMedicine":"syrup", "countOfDays":"30", "doseOfMedicine":"10 ml"}]}]}' })
    @ApiUnauthorizedResponse({ description: 'Invalid credentials' })
